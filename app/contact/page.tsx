...
export default function ContactPage() {
  ...
  const socialLinks = [
    ...
    {
      name: "Email",
      url: "mailto:dareean@example.com",
      icon: (
            ...
            {isSubmitted ? (
              ...
              <form onSubmit={handleSubmit} className="bg-white rounded-2xl p-8 md:p-12 shadow-sm">
                <div className="space-y-6">
                  {/* Name */}
                  <div>
                    <label htmlFor="name" className="block text-sm font-medium text-off-white/80 mb-2">
                      Your Name
                    </label>
                    <input
                      type="text"
                  ...
                  {/* Email */}
                  <div>
                    <label htmlFor="email" className="block text-sm font-medium text-off-white/80 mb-2">
                      Email Address
                    </label>
                    <input
                      type="email"
                  ...
                  {/* Subject */}
                  <div>
                    <label htmlFor="subject" className="block text-sm font-medium text-off-white/80 mb-2">
                      Subject
                    </label>
                    <select
                      id="subject"
                  ...
                  {/* Message */}
                  <div>
                    <label htmlFor="message" className="block text-sm font-medium text-off-white/80 mb-2">
                      Message
                    </label>
                    <textarea
                      id="message"
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-off-white/60 text-sm leading-relaxed">
                    I usually respond within 24 hours. Feel free to reach out anytime—whether it&apos;s about a project, an idea, or just to chat about tech!
                  </p>
                </div>
              </div>
            </div>
