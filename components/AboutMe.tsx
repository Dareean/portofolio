...
export default function AboutMe() {
  ...
  useLayoutEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      const techStackContainer = containerRef.current?.querySelector('.tech-stack-container');
      ...
      const marqueeTrack = containerRef.current?.querySelector('.tech-marquee-track');
      if (marqueeTrack) {
        ...
        (window as unknown as { techMarqueeTl?: gsap.core.Tween }).techMarqueeTl = tl;
      }
    }, containerRef);
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-4 sm:gap-5 md:gap-6">
          ...
          <div className="md:col-span-7 lg:col-span-8 flex flex-col gap-4 sm:gap-5 md:gap-6">
            ...
            <div 
              ...
              onMouseEnter={() => {
                const tl = (window as unknown as { techMarqueeTl?: gsap.core.Tween }).techMarqueeTl;
            ...
            >
              ...
              <div 
                ...
                style={{ 
                  background: 'linear-gradient(to right, rgb(var(--background-rgb)) 0%, rgb(var(--background-rgb)) 10%, transparent 100%)'
                }}
              />
              ...
              <div 
                ...
                style={{ 
                  background: 'linear-gradient(to left, rgb(var(--background-rgb)) 0%, rgb(var(--background-rgb)) 10%, transparent 100%)'
                }}
              />
                ...
                {[...Array(2)].map((_, setIndex) => (
                  <div key={setIndex} className="flex items-center gap-12 sm:gap-16 md:gap-20 px-6 sm:px-8">
                    {[
                      ...
                      { name: "GSAP", path: "M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm0 2.4c5.302 0 9.6 4.298 9.6 9.6s-4.298 9.6-9.6 9.6-9.6-4.298-9.6-9.6 4.298-9.6 9.6-9.6zm-2.4 4.8v9.6l7.2-4.8z" },
                    ].map((tech, idx) => (
                      <div
                        key={`${setIndex}-${idx}`}
